...
public class ScriptableObjectDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (property.objectReferenceValue != null && AreAnySubPropertiesVisible(property))
        {
            ...
            const int offset = 2;
            EditorGUI.PropertyField(new Rect(EditorGUIUtility.labelWidth + offset , position.y, position.width - EditorGUIUtility.labelWidth - offset, EditorGUIUtility.singleLineHeight), property, GUIContent.none, true);
	...
	public static T _GUILayout<T> (GUIContent label, T objectReferenceValue, ref bool isExpanded) where T : ScriptableObject {
		...
		if(objectReferenceValue != null) {
			...
			propertyRect = new Rect(position.x + EditorGUIUtility.currentViewWidth - indentOffset, position.y, position.width - EditorGUIUtility.currentViewWidth - indentOffset, EditorGUIUtility.singleLineHeight);
		} else {
